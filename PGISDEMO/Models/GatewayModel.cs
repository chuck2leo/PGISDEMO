...
namespace PGISDEMO.Models
{
    ...
    public class GatewayModel
    {
        ...
        public static List<GatewayModel> GetAllDevice()
        {
            ...
            list.Add(new GatewayModel("002", "34.592044830322266", "113.690055847167970", "龙湖镇富源路与107国道交叉口西南角"));
            list.Add(new GatewayModel("003", "34.629940032958984", "113.687667846679690", "龙湖镇正商红河谷东南门西北侧30米"));
            list.Add(new GatewayModel("004", "34.823562622070310", "113.705047607421880", "中州大道21世纪社区东门岗亭向东10米"));
            list.Add(new GatewayModel("005", "34.842208862304690", "113.670982360839840", "安泰银河小区8号楼东北侧"));
            list.Add(new GatewayModel("006", "34.825103759765625", "113.688941955566400", "花园路国基路交叉口东南角绿化带"));
            return list;
        }
    }
}