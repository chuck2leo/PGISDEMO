EzServerClient = {
    GlobeParams: {
		 ...
		 */
        MapSrcURL: [
                   //["天地图Online", ["http://t0.tianditu.com/vec_c/wmts",  // liuchao:/vec_c/矢量底图
                   ...
                   //                ["http://t0.tianditu.com/cva_c/wmts",  //  liuchao:/cva_c/矢量注记
                   ...
                   ["ArcGis Online", ["http://cache1.arcgisonline.cn/arcgis/rest/services/ChinaOnlineCommunity/MapServer"], "ArcGis"],
                   ["天地图Online", ["http://t0.tianditu.com/vec_c/wmts"], ["http://t0.tianditu.com/cva_c/wmts"], "WMTS_[{layer:'vec',style:'default',tileMatrixSet:'c',originAnchor:[-180,90],initResolution:1.40625,format:'tiles',tileMatrix:'%d',source:'wmts'},{layer:'cva',style:'default',tileMatrixSet:'c',originAnchor:[-180,90],initResolution:1.40625,format:'tiles',tileMatrix:'%d',source:'wmts'}]"],
                   ...
                   //["ArcGis-Tdr-TEST", ["http://localhost:6080/arcgis/rest/services/XinZheng01/MapServer"], "ArcGis-TDR-TEST"],  //郑州新郑
                   //["百度地图", ["暂无图层"], "Baidu"],  //  百度地图图层
		 ...
		 *参数举例：如下所示
		 */
        CenterPoint: [113.6425221008991, 34.754920317235],
        /**
		 *参数说明：设置全图显示时地图显示范围
		 ...
		 *参数举例：如下所示
		 */
        MapFullExtent: [120.59423, 27.93786, 120.8059, 28.06774],  //西、南、东、北
        /**
		 *参数说明：设置地图初始显示级别
		 *参数类型：{Float}
		 *取值范围：无限制
...
DO_LOAD_EzServerClient_JS = false;  //liuchao: 设置为true自动加载时，会导致Chrome调试器“延迟”一步执行，暂改为各页面手动加载EzServerClient.js
